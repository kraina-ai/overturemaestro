...
@P.case(
    "Wrong theme & type",
    ["wrong_theme", "wrong_type", "--geom-filter-bbox", str(geometry_bbox_str())],
)  # type: ignore
@P.case(
    "Wrong theme",
    ["wrong_theme", "building", "--geom-filter-bbox", str(geometry_bbox_str())],
)  # type: ignore
@P.case(
    "Wrong type",
    ["buildings", "wrong_type", "--geom-filter-bbox", str(geometry_bbox_str())],
)  # type: ignore
@P.case(
    "Wrong release",
    [
