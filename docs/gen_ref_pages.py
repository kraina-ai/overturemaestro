...
if is_dev:
    for path in sorted(Path("overturemaestro").rglob("*.py")):
        module_path = path.relative_to("overturemaestro").with_suffix("")
        doc_path = path.relative_to("overturemaestro").with_suffix(".md")
